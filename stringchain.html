...
<body>
    ...
    <div id="dropdown" style="display:none;">
        ...
        <div id="about" style="display: none;">
            <p style="text-align: left;"> <b>ABOUT</b>
                ...
                <br>
                <br>The rewards and penalties incentivise exciting gameplay.
                There are lots of strategies you might employ. You must break the 6-letter barrier to see your milestones and avail of the 4x4 letter grid.
                <br><br>You could then retreat to short words, rack up string bonuses, chain bonuses, and no-bonus streaks finding new more efficient paths through all the obvious and convenient short words.
                The no-bonus streak rewards caution. 
                <br><br>Sustaining yourself in the long word realm will require burning through some of those bonuses. 
                Bonuses help you to bridge gaps between longer words that can't be chained in a single move.
                And you must reach long words to gain extra lives. You unlock extra lives by playing 7+ letter words. 
                <br><br>Every extra life you gain adds another consecutive bonus to your allowance. Even lost lives still count towards this allowance.
                This incentivises shooting for longer words to increase the consecutive bonus penalty threshold.
                <br><br>Cautious or reckless, methodical or impulsive, you'll find your style, find your pace, find your flow. You choose your own adventure (or 'misadventure' to grab the 12 letter reward).
                <br>
                <br>Get a high score. Beat that high score. Screenshot that high score and challenge your
                friends. Look at your wordlist, you made that! Look at all the words you know, all these rhymes and connections! Writers, rappers, poets, word enthusiasts, this is your groove.
                <br>
                <br>Future tweaks and updates are planned, but the core game is in place, have at it.
                <br>
    ...
    <div class="game-area"> <!-- Fixed width matching your history area -->
        ...
        <div class="play-grid-layout">
            ...
            <div class="rail left-rail">
                <button id="missionsBtn" class="rail-btn span-0 opacity-hide">&</button>
    ...
    <div id="asteriskModal" class="modal hidden">
        <div class="modal-wildcard">
            ...
            <p class="demo-para hidden" style="text-align:justify;font-size:12pt;" id="wildcard-3">
    ...
    <div id="milestonesModal" class="modal-1 hidden">
        <div class="modal-milestones">
            ...
            <h6>MILESTONES</h6>
            <p class="demo-para" style="text-align:center;font-size:9pt;margin-top:-8px;">THIS GAME
                <br><br></p>
...
<!--#endregion Missions Modal -->
        ...
        <script>
            ...
            const missions = {
                ...
                "5": ["OUIJA", "DISCO", "NYMPH", "IRONY", "KUDOS", "WHARF"],
...
//             }
            ...
            function loadGameState() {
                ...
                try {
                    ...
                    updateStatus();
                    loadLocalWords();
                    if (gridSize == 3) { missionsBtn.classList.add("span-0"); gridRefreshBtn.classList.remove("span-2"); milestonesBtn.classList.add("hidden"); }
                    if (gridSize == 4) { missionsBtn.classList.remove("span-0"); gridRefreshBtn.classList.add("span-2"); milestonesBtn.classList.remove("hidden"); }
                    scoreElement.textContent = score;
                    chainElement.textContent = chain;
            ...
            function nextMileStones() {
                ...
                <table style="border:none;width:360px;">
                    <tr style="border:none;padding:none;">
                        <td style="border:none;width:50%;padding:2px;margin:0px;">
            ...
            function checkMission(currentWord) {
                ...
                // Recalculate unlock condition
                const totalUnlocked = Object.entries(missions)
                    .filter(([len]) => Number(len) <= unlockedMissionTier)
                    .reduce((sum, [, words]) => sum + words.length, 0);

                const completedUnlocked = [...completedMissions].filter(
                    word => word.length <= unlockedMissionTier
                ).length;

                if (completedUnlocked / totalUnlocked >= 0.5) {
                    unlockedMissionTier++;
                }


                // // Unlock next tier if this was the frontier
                // if (len === unlockedMissionTier) {
                //     unlockedMissionTier++;
                // }
